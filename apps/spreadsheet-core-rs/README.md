...
`/v1/openapi` mirrors these workflows with machine-readable path summaries for health + spec discovery endpoints, wizard discovery/run endpoints, agent cache lifecycle endpoints, DuckDB query execution, and workbook event streaming.
