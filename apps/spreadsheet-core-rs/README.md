...
- file-based fixture corpus regression coverage (`fixtures/compat_baseline.xlsx`, `fixtures/compat_formula_matrix.xlsx`, `fixtures/compat_default_cached_formula.xlsx`, `fixtures/compat_error_cached_formula.xlsx`, `fixtures/compat_normalization_single.xlsx`, `fixtures/compat_normalization.xlsx`, `fixtures/compat_offset_range.xlsx`, `fixtures/compat_unsupported_formula.xlsx`, `fixtures/compat_mixed_literal_prefix.xlsx`, `fixtures/compat_prefix_operator.xlsx`) to validate import behavior against generated workbook artifacts,
