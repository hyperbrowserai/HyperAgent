...
Automated regression guard: `store::tests::should_recalculate_large_range_aggregates_consistently` validates a 2,000-row aggregate recalc stays under a 2-second recalc budget.
