...
`/v1/workbooks/{id}/agent/schema` also advertises workbook import/export endpoint metadata (including `x-export-meta` header shape, import formula-metric response fields, and workbook import/export event payload shapes) for agent discoverability.
