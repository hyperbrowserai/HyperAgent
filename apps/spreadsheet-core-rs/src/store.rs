use crate::{
    error::ApiError,
    formula::{
        address_from_row_col, parse_abs_formula, parse_acos_formula, parse_acosh_formula,
        parse_acot_formula, parse_acoth_formula, parse_acsc_formula, parse_acsch_formula,
        parse_aggregate_formula, parse_and_formula, parse_arabic_formula, parse_asec_formula,
        parse_asech_formula, parse_asin_formula, parse_asinh_formula, parse_atan2_formula,
        parse_atan_formula, parse_atanh_formula, parse_avedev_formula, parse_averagea_formula,
        parse_averageif_formula, parse_averageifs_formula, parse_base_formula,
        parse_bin2dec_formula, parse_bin2hex_formula, parse_bin2oct_formula, parse_bitand_formula,
        parse_bitlshift_formula, parse_bitor_formula, parse_bitrshift_formula,
        parse_bitxor_formula, parse_ceiling_formula, parse_ceiling_math_formula,
        parse_cell_address, parse_char_formula, parse_choose_formula, parse_clean_formula,
        parse_code_formula, parse_column_formula, parse_columns_formula, parse_combin_formula,
        parse_combina_formula, parse_concat_formula, parse_correl_formula, parse_cos_formula,
        parse_cosh_formula, parse_cot_formula, parse_coth_formula, parse_counta_formula,
        parse_countblank_formula, parse_countif_formula, parse_countifs_formula,
        parse_covariance_formula, parse_csc_formula, parse_csch_formula, parse_cumipmt_formula,
        parse_cumprinc_formula, parse_date_formula, parse_datedif_formula, parse_datevalue_formula,
        parse_day_formula, parse_days360_formula, parse_days_formula, parse_db_formula,
        parse_ddb_formula, parse_dec2bin_formula, parse_dec2hex_formula, parse_dec2oct_formula,
        parse_decimal_formula, parse_degrees_formula, parse_delta_formula, parse_devsq_formula,
        parse_dollarde_formula, parse_dollarfr_formula, parse_edate_formula, parse_effect_formula,
        parse_eomonth_formula, parse_even_formula, parse_exact_formula, parse_exp_formula,
        parse_fact_formula, parse_factdouble_formula, parse_false_formula, parse_find_formula,
        parse_fisher_formula, parse_fisherinv_formula, parse_floor_formula,
        parse_floor_math_formula, parse_forecast_linear_formula, parse_fv_formula,
        parse_fvschedule_formula, parse_gcd_formula, parse_geomean_formula, parse_gestep_formula,
        parse_harmean_formula, parse_hex2bin_formula, parse_hex2dec_formula, parse_hlookup_formula,
        parse_hour_formula, parse_if_formula, parse_iferror_formula, parse_ifna_formula,
        parse_ifs_formula, parse_index_formula, parse_int_formula, parse_intercept_formula,
        parse_ipmt_formula, parse_irr_formula, parse_isblank_formula, parse_iseven_formula,
        parse_isnumber_formula, parse_isodd_formula, parse_isoweeknum_formula, parse_ispmt_formula,
        parse_istext_formula, parse_kurt_formula, parse_large_formula, parse_lcm_formula,
        parse_left_formula, parse_len_formula, parse_ln_formula, parse_log10_formula,
        parse_log_formula, parse_lower_formula, parse_match_formula, parse_maxa_formula,
        parse_maxifs_formula, parse_mid_formula, parse_mina_formula, parse_minifs_formula,
        parse_minute_formula, parse_mirr_formula, parse_mod_formula, parse_mode_sngl_formula,
        parse_month_formula, parse_mround_formula, parse_multinomial_formula, parse_n_formula,
        parse_na_formula, parse_networkdays_formula, parse_networkdays_intl_formula,
        parse_nominal_formula, parse_not_formula, parse_now_formula, parse_nper_formula,
        parse_npv_formula, parse_oct2bin_formula, parse_oct2dec_formula, parse_odd_formula,
        parse_or_formula, parse_pduration_formula, parse_percentile_exc_formula,
        parse_percentile_inc_formula, parse_percentrank_exc_formula, parse_percentrank_inc_formula,
        parse_permut_formula, parse_permutationa_formula, parse_pi_formula, parse_pmt_formula,
        parse_power_formula, parse_ppmt_formula, parse_proper_formula, parse_pv_formula,
        parse_quartile_exc_formula, parse_quartile_inc_formula, parse_quotient_formula,
        parse_radians_formula, parse_rand_formula, parse_randbetween_formula, parse_rank_formula,
        parse_rate_formula, parse_replace_formula, parse_rept_formula, parse_right_formula,
        parse_roman_formula, parse_round_formula, parse_rounddown_formula, parse_roundup_formula,
        parse_row_formula, parse_rows_formula, parse_rri_formula, parse_rsq_formula,
        parse_search_formula, parse_sec_formula, parse_sech_formula, parse_second_formula,
        parse_seriessum_formula, parse_sign_formula, parse_sin_formula, parse_single_ref_formula,
        parse_sinh_formula, parse_skew_formula, parse_skew_p_formula, parse_sln_formula,
        parse_slope_formula, parse_small_formula, parse_sqrt_formula, parse_stdeva_formula,
        parse_stdevpa_formula, parse_steyx_formula, parse_substitute_formula, parse_sumif_formula,
        parse_sumifs_formula, parse_sumproduct_formula, parse_sumx_formula, parse_switch_formula,
        parse_syd_formula, parse_t_formula, parse_tan_formula, parse_tanh_formula,
        parse_textjoin_formula, parse_time_formula, parse_timevalue_formula, parse_today_formula,
        parse_trim_formula, parse_trimmean_formula, parse_true_formula, parse_trunc_formula,
        parse_unichar_formula, parse_unicode_formula, parse_upper_formula, parse_value_formula,
        parse_vara_formula, parse_varpa_formula, parse_vlookup_formula, parse_weekday_formula,
        parse_weeknum_formula, parse_workday_formula, parse_workday_intl_formula,
        parse_xirr_formula, parse_xlookup_formula, parse_xnpv_formula, parse_xor_formula,
        parse_year_formula, parse_yearfrac_formula, ConditionalAggregateFormula, HLookupFormula,
        IndexFormula, MatchFormula, MultiCriteriaAggregateFormula, VLookupFormula, XLookupFormula,
    },
...
const DEFAULT_DUCKDB_QUERY_ROW_LIMIT: usize = 200;
const MAX_DUCKDB_QUERY_ROW_LIMIT: usize = 1000;
...
pub fn run_duckdb_query(
    db_path: &PathBuf,
    sql: &str,
    row_limit: Option<u32>,
) -> Result<QueryResponse, ApiError> {
    let normalized_sql = normalize_duckdb_query_sql(sql)?;
    let applied_row_limit = normalize_duckdb_query_row_limit(row_limit)?;
    let connection = Connection::open(db_path).map_err(ApiError::internal)?;

    let mut describe_statement = connection
        .prepare(format!("DESCRIBE SELECT * FROM ({normalized_sql}) AS agent_query").as_str())
        .map_err(map_invalid_duckdb_query_error)?;
    let described_columns = describe_statement
        .query_map([], |row| row.get::<_, String>(0))
        .map_err(map_invalid_duckdb_query_error)?;
    let mut columns = Vec::new();
    for described_column in described_columns {
        columns.push(described_column.map_err(map_invalid_duckdb_query_error)?);
    }
    ...
    let projection = columns
        ...
        .map(|(column_index, column_name)| {
            format!(
                "CAST({} AS VARCHAR) AS {}",
                quote_duckdb_identifier(column_name.as_str()),
                quote_duckdb_identifier(format!("agent_query_col_{}", column_index + 1).as_str()),
            )
        })
        .collect::<Vec<_>>()
        .join(", ");
    ...
    let mut statement = connection
        .prepare(
            format!(
                "SELECT {projection} FROM ({normalized_sql}) AS agent_query LIMIT {}",
                applied_row_limit + 1
            )
            .as_str(),
        )
    ...
    for row in rows_iter {
        rows.push(row.map_err(map_invalid_duckdb_query_error)?);
    }

    let truncated = rows.len() > applied_row_limit;
    if truncated {
        rows.truncate(applied_row_limit);
    }
...
fn normalize_duckdb_query_sql(sql: &str) -> Result<String, ApiError> {
    ...
    let forbidden_sql_pattern = Regex::new(
    r"\b(INSERT|UPDATE|DELETE|ALTER|DROP|CREATE|REPLACE|TRUNCATE|ATTACH|DETACH|COPY|CALL|EXPORT|IMPORT|INSTALL|LOAD|PRAGMA|SET|RESET|VACUUM|ANALYZE)\b",
  )
  .map_err(ApiError::internal)?;
    if forbidden_sql_pattern.is_match(uppercase_sql.as_str()) {
        return Err(ApiError::bad_request_with_code(
            "INVALID_QUERY_SQL",
            "DuckDB query contains disallowed non-read-only SQL keywords.",
        ));
    }
...
fn normalize_duckdb_query_row_limit(row_limit: Option<u32>) -> Result<usize, ApiError> {
    match row_limit {
        None => Ok(DEFAULT_DUCKDB_QUERY_ROW_LIMIT),
        Some(0) => Err(ApiError::bad_request_with_code(
            "INVALID_QUERY_ROW_LIMIT",
            "row_limit must be greater than 0 when provided.",
        )),
        Some(value) => {
            let normalized = usize::try_from(value).unwrap_or(MAX_DUCKDB_QUERY_ROW_LIMIT);
            Ok(normalized.min(MAX_DUCKDB_QUERY_ROW_LIMIT))
        }
    }
}
...
fn map_invalid_duckdb_query_error<E: std::fmt::Display>(error: E) -> ApiError {
    ApiError::bad_request_with_code("INVALID_QUERY_SQL", format!("DuckDB query failed: {error}"))
}

pub fn recalculate_formulas(db_path: &PathBuf) -> Result<(usize, Vec<String>), ApiError> {
    let connection = Connection::open(db_path).map_err(ApiError::internal)?;
    let mut statement = connection
        .prepare(
            r#"
...
pub fn load_sheet_snapshot(db_path: &PathBuf, sheet: &str) -> Result<Vec<CellSnapshot>, ApiError> {
    let connection = Connection::open(db_path).map_err(ApiError::internal)?;
    let mut statement = connection
        .prepare(
            r#"
...
fn evaluate_formula(
    ...
    if let Some((start, end, trim_percent_arg)) = parse_trimmean_formula(formula) {
        ...
        let mean = trimmed_values.iter().sum::<f64>() / trimmed_values.len() as f64;
        return Ok(Some(mean.to_string()));
    }
    ...
    if let Some((start, end)) = parse_avedev_formula(formula) {
        ...
        let mean = values.iter().sum::<f64>() / values.len() as f64;
        let total_absolute_deviation = values
            .iter()
    ...
    if let Some((left_start, left_end, right_start, right_end)) = parse_correl_formula(formula) {
        let Some(pairs) = collect_numeric_pairs_from_ranges(
            connection,
            sheet,
            left_start,
    ...
    if let Some((start, end, target_arg, significance_arg)) = parse_percentrank_inc_formula(formula)
    {
        ...
        let significance = match significance_arg {
            Some(raw_significance) => Some(parse_required_unsigned(
                connection,
                sheet,
                &raw_significance,
            )?),
        ...
        parse_textjoin_formula(formula)
    {
        ...
        let ignore_empty_value = resolve_scalar_operand(connection, sheet, &ignore_empty_operand)?;
        let ignore_empty = resolve_truthy_operand(&ignore_empty_value);
        let mut values = Vec::new();
        for operand in text_operands {
            let resolved_values = resolve_textjoin_argument_values(connection, sheet, &operand)?;
    ...
    if let Some(not_arg) = parse_not_formula(formula) {
        return Ok(Some(
            (!evaluate_if_condition(connection, sheet, &not_arg)?).to_string(),
        ));
    }
    ...
    if let Some(t_arg) = parse_t_formula(formula) {
        ...
        let trimmed = value.trim();
        let normalized = trimmed.to_uppercase();
        if trimmed.parse::<f64>().is_ok() || normalized == "TRUE" || normalized == "FALSE" {
            return Ok(Some(String::new()));
        }
        return Ok(Some(value));
    }
    ...
    if let Some((fractional_dollar_arg, fraction_arg)) = parse_dollarde_formula(formula) {
        let fractional_dollar_raw =
            resolve_scalar_operand(connection, sheet, &fractional_dollar_arg)?;
        let fraction_raw = resolve_scalar_operand(connection, sheet, &fraction_arg)?;
        let fractional_dollar = fractional_dollar_raw
            .trim()
            .parse::<f64>()
            .unwrap_or_default();
    ...
    if let Some((nper_arg, pmt_arg, pv_arg, fv_arg, type_arg, guess_arg)) =
        parse_rate_formula(formula)
    {
        let periods = parse_required_float(connection, sheet, &nper_arg)?;
        if periods <= 0.0 {
            return Ok(None);
    ...
    if let Some((rate_arg, period_arg, nper_arg, pv_arg, fv_arg, type_arg)) =
        parse_ipmt_formula(formula)
    {
        let rate = parse_required_float(connection, sheet, &rate_arg)?;
    ...
    if let Some((cost_arg, salvage_arg, life_arg, period_arg, month_arg)) =
        parse_db_formula(formula)
    {
        let cost = parse_required_float(connection, sheet, &cost_arg)?;
        let salvage = parse_required_float(connection, sheet, &salvage_arg)?;
        let life = parse_required_float(connection, sheet, &life_arg)?;
    ...
    if let Some((cost_arg, salvage_arg, life_arg, period_arg, factor_arg)) =
        parse_ddb_formula(formula)
    {
        let cost = parse_required_float(connection, sheet, &cost_arg)?;
        let salvage = parse_required_float(connection, sheet, &salvage_arg)?;
        let life = parse_required_float(connection, sheet, &life_arg)?;
    ...
    if let Some((x_arg, n_arg, m_arg, coefficients_arg)) = parse_seriessum_formula(formula) {
        ...
        let coefficients =
            resolve_numeric_values_for_operand(connection, sheet, &coefficients_arg)?;
    ...
    if let Some((value_arg, significance_arg, mode_arg)) = parse_ceiling_math_formula(formula) {
        let value = parse_required_float(connection, sheet, &value_arg)?;
        let significance = match significance_arg {
    ...
    if let Some((value_arg, multiple_arg)) = parse_mround_formula(formula) {
        ...
        if value.is_sign_positive() != multiple.is_sign_positive() && value.abs() > f64::EPSILON {
            return Ok(None);
        }
    ...
    if let Some((old_text_arg, start_arg, count_arg, new_text_arg)) = parse_replace_formula(formula)
    {
        ...
        let prefix = old_chars
            ...
            .collect::<String>();
        let suffix_start = start_index
            .saturating_add(replace_count)
            .min(old_chars.len());
    ...
    if let Some((find_text_arg, within_text_arg, start_num_arg)) = parse_search_formula(formula) {
    ...
    if let Some((find_text_arg, within_text_arg, start_num_arg)) = parse_find_formula(formula) {
        let find_text = resolve_scalar_operand(connection, sheet, &find_text_arg)?;
        let within_text = resolve_scalar_operand(connection, sheet, &within_text_arg)?;
        let start_num = match start_num_arg {
            Some(raw_start) => parse_required_integer(connection, sheet, &raw_start)?,
    ...
    if let Some((hour_arg, minute_arg, second_arg)) = parse_time_formula(formula) {
        ...
        let total_seconds = i64::from(hours) * 3_600 + i64::from(minutes) * 60 + i64::from(seconds);
    ...
    if let Some((start_date_arg, end_date_arg, holidays_arg)) = parse_networkdays_formula(formula) {
        let start_date = parse_date_operand(connection, sheet, &start_date_arg)?;
        let end_date = parse_date_operand(connection, sheet, &end_date_arg)?;
        let (Some(start_value), Some(end_value)) = (start_date, end_date) else {
            return Ok(None);
    ...
    if let Some((start_date_arg, day_offset_arg, holidays_arg)) = parse_workday_formula(formula) {
        let start_date = parse_date_operand(connection, sheet, &start_date_arg)?;
    ...
    if let Some(year_arg) = parse_year_formula(formula) {
        ...
        return Ok(Some(
            date.map(|value| value.year().to_string())
                .unwrap_or_default(),
        ));
    }
    ...
    if let Some(month_arg) = parse_month_formula(formula) {
        ...
        return Ok(Some(
            date.map(|value| value.month().to_string())
                .unwrap_or_default(),
        ));
    }
    ...
    if let Some(day_arg) = parse_day_formula(formula) {
        ...
        return Ok(Some(
            date.map(|value| value.day().to_string())
                .unwrap_or_default(),
        ));
    }
    ...
    if let Some(hour_arg) = parse_hour_formula(formula) {
        ...
        return Ok(Some(
            time.map(|value| value.hour().to_string())
                .unwrap_or_default(),
        ));
    }
    ...
    if let Some(minute_arg) = parse_minute_formula(formula) {
        ...
        return Ok(Some(
            time.map(|value| value.minute().to_string())
                .unwrap_or_default(),
        ));
    }
    ...
    if let Some(second_arg) = parse_second_formula(formula) {
        ...
        return Ok(Some(
            time.map(|value| value.second().to_string())
                .unwrap_or_default(),
        ));
    }
...
fn evaluate_sumif_formula(
    ...
    for (criteria_row, criteria_col, value_row, value_col) in cell_pairs {
        let candidate = load_cell_scalar(connection, sheet, criteria_row, criteria_col)?;
        if !countif_matches_criteria(&candidate, &criteria) {
            continue;
        }
...
fn build_conditional_cell_pairs(
    ...
    let (value_start_row, value_end_row, value_start_col, value_end_col) =
        match (formula.value_range_start, formula.value_range_end) {
            (Some(start), Some(end)) => (
                start.0.min(end.0),
                start.0.max(end.0),
                start.1.min(end.1),
...
fn collect_numeric_pairs_from_ranges(
    ...
    if left_bounds.width != right_bounds.width || left_bounds.height != right_bounds.height {
        return Ok(None);
    }
...
fn evaluate_countifs_formula(
    ...
    let criteria_bounds =
        normalized_range_bounds(first_condition.range_start, first_condition.range_end);
...
fn evaluate_sumifs_formula(
    ...
    let Some((value_bounds, conditions)) =
        build_multi_criteria_runtime(connection, sheet, formula)?
    else {
        return Ok(None);
    };
...
fn build_multi_criteria_runtime(
    ...
    let (Some(value_start), Some(value_end)) = (formula.value_range_start, formula.value_range_end)
    else {
        return Ok(None);
    };
    ...
    let mut conditions = Vec::new();
    for condition in &formula.conditions {
        let condition_bounds = normalized_range_bounds(condition.range_start, condition.range_end);
...
fn evaluate_if_condition(
    ...
    Ok(resolve_truthy_operand(&resolve_scalar_operand(
        connection, sheet, condition,
    )?))
}
...
fn calculate_cumulative_payment_parts(
    ...
    for period in start_period..=end_period {
        let (interest_payment, principal_payment) =
            calculate_ipmt_ppmt(rate, period, periods, present_value, 0.0, payment_type)?;
...
fn matches_lookup_value(candidate: &str, lookup_value: &str, lookup_numeric: Option<f64>) -> bool {
...
fn replace_nth_occurrence(text: &str, from: &str, to: &str, instance: usize) -> String {
    if instance == 0 {
...
fn shift_year_month(year: i32, month: u32, months_delta: i32) -> Option<(i32, u32)> {
...
fn shift_date_by_months(date: NaiveDate, months_delta: i32) -> Option<NaiveDate> {
    let (shifted_year, shifted_month) = shift_year_month(date.year(), date.month(), months_delta)?;
...
fn actual_actual_yearfrac(start: NaiveDate, end: NaiveDate) -> f64 {
    ...
    while cursor < to {
        let next_year_start = NaiveDate::from_ymd_opt(cursor.year() + 1, 1, 1).unwrap_or(to);
...
fn evaluate_xlookup_formula(
    ...
    let match_mode =
        parse_lookup_mode_operand(connection, sheet, formula.match_mode.as_deref(), 0)?;
    if match_mode != 0 {
        return Ok(None);
    }
    let search_mode =
        parse_lookup_mode_operand(connection, sheet, formula.search_mode.as_deref(), 1)?;
    ...
    if is_vertical_lookup {
        ...
        for offset in offsets {
            ...
            let candidate = load_cell_scalar(connection, sheet, lookup_row, lookup_start_col)?;
            if !matches_lookup_value(&candidate, &lookup_value, lookup_numeric) {
                continue;
            }
            let return_row = return_start_row + offset;
            let resolved = load_cell_scalar(connection, sheet, return_row, return_start_col)?;
            return Ok(Some(resolved));
        }
    } else {
        ...
        for offset in offsets {
            ...
            let candidate = load_cell_scalar(connection, sheet, lookup_start_row, lookup_col)?;
            if !matches_lookup_value(&candidate, &lookup_value, lookup_numeric) {
                continue;
            }
            let return_col = return_start_col + offset;
            let resolved = load_cell_scalar(connection, sheet, return_start_row, return_col)?;
            return Ok(Some(resolved));
        }
    }
...
fn evaluate_match_formula(
    ...
    let match_type =
        parse_lookup_mode_operand(connection, sheet, formula.match_type.as_deref(), 0)?;
    if match_type != 0 {
        return Ok(None);
    }
...
mod tests {
    ...
    fn should_reject_blank_formula_inputs_on_set_cells() {
        ...
        let error = set_cells(&db_path, "Sheet1", &cells).expect_err("blank formula should fail");
        match error {
            ApiError::BadRequestWithCode { code, message } => {
                ...
                assert_eq!(
                    message, "Formula values cannot be blank.",
    ...
    fn benchmark_medium_range_set_cells_updates() {
        ...
        set_cells(&db_path, "PerfUpdates", &cells).expect("benchmark update should succeed");
    ...
    fn should_recalculate_if_concat_today_and_vlookup_formulas() {
        ...
        let cells = vec![
            ...
            CellMutation {
                ...
                col: 82,
                value: None,
                formula: Some(r#"=SUBSTITUTE("north-north-north","north","south",2)"#.to_string()),
            },
            CellMutation {
                row: 1,
                col: 83,
            ...
            CellMutation {
                ...
                value: None,
                formula: Some(
                    r#"=NETWORKDAYS("2024-03-01","2024-03-10","2024-03-04")"#.to_string(),
                ),
            },
            CellMutation {
                row: 1,
                ...
                value: None,
                formula: Some(
                    r#"=NETWORKDAYS("2024-03-10","2024-03-01","2024-03-04")"#.to_string(),
                ),
            },
            CellMutation {
                row: 1,
            ...
            CellMutation {
                ...
                value: None,
                formula: Some(
                    r#"=NETWORKDAYS.INTL("2024-03-01","2024-03-10","0000011","2024-03-04")"#
                        .to_string(),
                ),
            },
            CellMutation {
        ...
        assert_eq!(by_position(1, 2).evaluated_value.as_deref(), Some("bonus"),);
        assert_eq!(
        ...
        assert_eq!(
            by_position(1, 10).evaluated_value.as_deref(),
            Some("spread")
        );
        assert_eq!(by_position(1, 11).evaluated_value.as_deref(), Some("sheet"));
        assert_eq!(
            by_position(1, 12).evaluated_value.as_deref(),
            Some("2026-02-13")
        );
        ...
        assert_eq!(
            by_position(1, 19).evaluated_value.as_deref(),
            Some("eligible")
        );
        assert_eq!(
            by_position(1, 20).evaluated_value.as_deref(),
            Some("Northeast")
        );
        assert_eq!(
            by_position(1, 21).evaluated_value.as_deref(),
            Some("fallback")
        );
        assert_eq!(
            by_position(1, 22).evaluated_value.as_deref(),
            Some("Southeast")
        );
        ...
        assert_eq!(
            by_position(1, 32).evaluated_value.as_deref(),
            Some("MIXED CASE")
        );
        assert_eq!(
            by_position(1, 33).evaluated_value.as_deref(),
            Some("mixed case")
        );
        assert_eq!(
            by_position(1, 34).evaluated_value.as_deref(),
            Some("north region")
        );
        assert_eq!(by_position(1, 35).evaluated_value.as_deref(), Some("2"));
        assert_eq!(by_position(1, 36).evaluated_value.as_deref(), Some("1"));
        assert_eq!(
            by_position(1, 37).evaluated_value.as_deref(),
            Some("Southeast")
        );
        ...
        assert_eq!(
            by_position(1, 43).evaluated_value.as_deref(),
            Some("fallback")
        );
        assert_eq!(
            by_position(1, 44).evaluated_value.as_deref(),
            Some("fallback")
        );
        assert_eq!(by_position(1, 45).evaluated_value.as_deref(), Some("120"));
        assert_eq!(
            by_position(1, 46).evaluated_value.as_deref(),
            Some("Southeast")
        );
        ...
        assert_eq!(
            by_position(1, 56).evaluated_value.as_deref(),
            Some("8.94427190999916")
        );
        assert_eq!(by_position(1, 57).evaluated_value.as_deref(), Some("12.5"));
        assert_eq!(
            by_position(1, 58).evaluated_value.as_deref(),
            Some("-12.25")
        );
        ...
        assert_eq!(
            by_position(1, 75).evaluated_value.as_deref(),
            Some("nananana")
        );
        ...
        assert_eq!(
            by_position(1, 80).evaluated_value.as_deref(),
            Some("worksheet")
        );
        assert_eq!(
        ...
        assert_eq!(
            by_position(1, 121).evaluated_value.as_deref(),
            Some("20800")
        );
        assert_eq!(by_position(1, 122).evaluated_value.as_deref(), Some("200"));
        assert_eq!(
            by_position(1, 123).evaluated_value.as_deref(),
            Some("20800.0")
        );
        ...
        assert_eq!(
            by_position(1, 129).evaluated_value.as_deref(),
            Some("100.0")
        );
        ...
        assert!(
            (var_p - 400.0).abs() < 1e-9,
            "var.p should be 400, got {var_p}"
        );
        ...
        assert!(
            (var_s - 800.0).abs() < 1e-9,
            "var.s should be 800, got {var_s}"
        );
        ...
        assert!(
            (devsq - 800.0).abs() < 1e-9,
            "devsq should be 800.0, got {devsq}"
        );
        ...
        assert!(
            (var_legacy - 800.0).abs() < 1e-9,
            "var should be 800.0, got {var_legacy}"
        );
        ...
        assert!(
            (varp_legacy - 400.0).abs() < 1e-9,
            "varp should be 400.0, got {varp_legacy}"
        );
        ...
        assert!(
            (averagea - 0.25).abs() < 1e-9,
            "averagea should be 0.25, got {averagea}"
        );
        ...
        assert!(
            (stdeva - 0.5).abs() < 1e-9,
            "stdeva should be 0.5, got {stdeva}"
        );
        ...
        assert!(
            (varpa - 0.1875).abs() < 1e-9,
            "varpa should be 0.1875, got {varpa}"
        );
        ...
        assert!(
            (correl - 1.0).abs() < 1e-9,
            "correl should be 1.0, got {correl}"
        );
        ...
        assert!(
            (covar - 800.0).abs() < 1e-9,
            "covar should be 800.0, got {covar}"
        );
        ...
        assert!((kurt + 1.2).abs() < 1e-9, "kurt should be -1.2, got {kurt}",);
    ...
    fn should_leave_invalid_mirr_inputs_as_unsupported() {
        ...
        assert_eq!(
            unsupported_formulas,
            vec!["=MIRR(A1:C1,-1,0.1)".to_string()]
        );
    }
    ...
    fn should_leave_invalid_sln_syd_inputs_as_unsupported() {
        ...
        assert_eq!(
            unsupported_formulas,
            vec![
                "=SLN(1000,100,0)".to_string(),
                "=SYD(1000,100,9,10)".to_string()
            ],
        );
    }
    ...
    fn should_leave_invalid_db_ddb_inputs_as_unsupported() {
        ...
        assert_eq!(
            unsupported_formulas,
            vec![
                "=DB(1000,100,5,1,0)".to_string(),
                "=DDB(1000,100,5,1,0)".to_string()
            ],
        );
    }
    ...
    fn should_leave_invalid_rri_pduration_inputs_as_unsupported() {
        ...
        assert_eq!(
            unsupported_formulas,
            vec![
                "=RRI(0,100,121)".to_string(),
                "=PDURATION(0,100,121)".to_string()
            ],
        );
    }
    ...
    fn should_leave_invalid_xnpv_inputs_as_unsupported() {
        ...
        assert_eq!(
            unsupported_formulas,
            vec!["=XNPV(0.1,A1:B1,A2:A2)".to_string()]
        );
    }
    ...
    fn should_leave_invalid_dollarde_dollarfr_inputs_as_unsupported() {
        ...
        assert_eq!(
            unsupported_formulas,
            vec![
                "=DOLLARDE(1.02,0)".to_string(),
                "=DOLLARFR(1.125,0)".to_string()
            ],
        );
    }
    ...
    fn should_leave_invalid_base_decimal_inputs_as_unsupported() {
        ...
        assert_eq!(
            unsupported_formulas,
            vec![
                "=BASE(255,1)".to_string(),
                r#"=DECIMAL("FF",1)"#.to_string()
            ],
        );
    }
    ...
    fn should_leave_correl_with_zero_variance_as_unsupported() {
        ...
        assert_eq!(
            unsupported_formulas,
            vec!["=CORREL(A1:A2,B1:B2)".to_string()]
        );
    }
    ...
    fn should_leave_search_without_match_as_unsupported() {
        ...
        assert_eq!(
            unsupported_formulas,
            vec![r#"=SEARCH("z","north")"#.to_string()]
        );
    }
    ...
    fn should_leave_find_case_mismatch_as_unsupported() {
        ...
        assert_eq!(
            unsupported_formulas,
            vec![r#"=FIND("S","southeast")"#.to_string()]
        );
    }
    ...
    fn should_leave_invalid_intl_weekend_patterns_as_unsupported() {
        ...
        let cells = vec![
            ...
            CellMutation {
                ...
                col: 2,
                value: None,
                formula: Some(r#"=WORKDAY.INTL("2024-03-01",5,"1111111")"#.to_string()),
            },
        ];
        set_cells(&db_path, "Sheet1", &cells).expect("cells should upsert");
