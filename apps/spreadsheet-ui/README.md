...
- Wizard schema panel now also shows discovered DuckDB query request/response shapes, DuckDB validation error codes, cache replay/reexecute/cleanup endpoints, cache replay/reexecute/cleanup request-response shapes, cache validation error codes, and structured operation-error payload fields
