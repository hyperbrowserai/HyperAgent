...
- Agent integration panel lists paged cached request IDs/signature prefixes with prefix filtering, newer/older pagination, and replay/copy/copy-ops/single-entry remove controls
