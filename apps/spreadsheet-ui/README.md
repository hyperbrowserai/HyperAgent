...
- Wizard and agent integration panels include one-click copy actions for discovered `openapi` endpoints
- Wizard and agent integration panels include one-click copy actions for discovered `openapi` plus `agent/ops` execute/preview endpoints
