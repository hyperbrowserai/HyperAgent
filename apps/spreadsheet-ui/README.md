...
- Latest `request_id` replay now calls dedicated cache replay API (does not require local operation plan state), and replay notices include source cache timestamp context
