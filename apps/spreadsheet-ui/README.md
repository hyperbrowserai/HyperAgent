...
- Agent integration panel lists paged cached request IDs/signature prefixes with newer/older pagination and replay/copy/copy-ops/single-entry remove controls
